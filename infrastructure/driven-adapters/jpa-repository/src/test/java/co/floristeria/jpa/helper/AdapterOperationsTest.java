package co.floristeria.jpa.helper;

import co.floristeria.jpa.otro.JPARepository;
import co.floristeria.jpa.otro.JPARepositoryAdapter;
...
class AdapterOperationsTest {
    ...
    void testFindById() {
        ...
        when(repository.findById(Long.valueOf("id"))).thenReturn(Optional.of(objectValue));

        Object result = adapter.findById(Long.valueOf("id"));
